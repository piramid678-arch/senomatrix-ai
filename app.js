...
const TARGET_DATABASE = [
  {
    ...
    sec_card1_desc: "LM Studio, Ollama 등 사내 독립 로컬 LLM 서버(Localhost/폐쇄망)와 직접 연동되어 연구 데이터가 외부 상용 AI 서버로 전송되지 않습니다.",
    ...
    sec_action_sub: "로컬 서버(LM Studio/Localhost) 주소 연동 및 타깃 단백질 심층 분석을 실시간으로 실행할 수 있습니다.",
    ...
    sec_card1_desc: "Directly interfaces with private local LLM servers (LM Studio, Ollama, vLLM on localhost). Zero bytes are transmitted to public AI clouds.",
    ...
    sec_action_sub: "Connect your local LLM (LM Studio / localhost) endpoint and run real-time in-depth target analysis.",
    ...
    sec_card1_desc: "LM StudioやOllamaなど社内独立ローカルLLMサーバーと直接連携し、機密研究データが外部サーバーへ送信されることは一切ありません。",
    ...
    sec_action_sub: "ローカルサーバー(LM Studio)のアドレスを連携し、ターゲットタンパク質の深層解析をリアルタイムで実行できます。",
    ...
    sec_card1_desc: "直接与LM Studio、Ollama等私有本地LLM服务器连接，核心研发数据绝不流向外部商业AI云端。",
    ...
    sec_action_sub: "连接本地服务器(LM Studio / localhost)地址，实时运行靶点深度尽调分析。",
    ...
    sec_card1_desc: "Direkte Schnittstelle zu lokalen LLMs (LM Studio, Ollama auf localhost). Keine Datenübertragung an öffentliche AI-Clouds.",
    ...
    sec_card1_desc: "Connexion directe avec vos serveurs LLM locaux privés (LM Studio, Ollama sur localhost). Aucun octet n'est transmis vers les clouds publics.",
...
const TRANSLATIONS = {
  ko: {
    ...
    btn_lmstudio_open: "⚡ LM Studio AI 분석기",
    ...
    lms_modal_title: "⚡ LM Studio AI 고급 자료 분석 엔진",
    lms_backend_lbl: "📡 백엔드 서버 주소:",
    ...
    btn_lms_execute: "⚡ LM Studio AI 한국어 고급 분석 보고서 생성",
    ...
    token_callout_desc: "💡 <strong>SenoMatrix AI 토큰 경제성 분석:</strong> 100페이지 바이오 실사 보고서(Bio-Dossier) 완본($1,200 상당)을 생성하는 데 소요되는 LLM 토큰 비용은 최상위 플래그십 AI 모델 기준 <strong>단 $2 ~ $3(약 3,000원)</strong>이며, 로컬 LM Studio(포트 1234) 이용 시 <strong>$0.00 (API 비용 0원)</strong>입니다.",
  ...
  en: {
    ...
    foot_security_txt: "🔒 Data Privacy & IP Safeguard Certified",
    btn_lmstudio_open: "⚡ LM Studio AI Analyzer",
    ...
    lms_modal_title: "⚡ LM Studio AI Advanced Analysis Engine",
    lms_backend_lbl: "📡 Backend Server Address:",
    ...
    btn_lms_execute: "⚡ Generate LM Studio AI In-Depth Report",
    nav_swarm: "⚡ 8인 AI 전문가 라이브",
    swarm_tag: "CLOUD HPC SERVER & 8 AI AGENT SWARM",
    ...
    token_callout_desc: "💡 <strong>SenoMatrix AI Token Economics:</strong> Generating a full 100-page Bio-Dossier (valued at $1,200) costs only <strong>$2 ~ $3</strong> with top flagship AI models (Claude 3.5 / GPT-4o), and <strong>$0.00 (Zero API cost)</strong> via local LM Studio.",
  ...
  ja: {
    ...
    foot_security_txt: "🔒 Data Privacy & IP Safeguard Certified",
    btn_lmstudio_open: "⚡ LM Studio AI 分析機",
    ...
    lms_modal_title: "⚡ LM Studio AI 高度データ解析エンジン",
    ...
    btn_lms_execute: "⚡ LM Studio AI による深層分析レポート生成",
    nav_swarm: "⚡ 8인 AI 전문가 라이브",
    swarm_tag: "CLOUD HPC SERVER & 8 AI AGENT SWARM",
  ...
  zh: {
    ...
    foot_security_txt: "🔒 Data Privacy & IP Safeguard Certified",
    btn_lmstudio_open: "⚡ LM Studio AI 分析器",
    ...
    lms_modal_title: "⚡ LM Studio AI 高级数据分析引擎",
    ...
    btn_lms_execute: "⚡ 生成 LM Studio AI 深度分析报告",
    nav_swarm: "⚡ 8인 AI 전문가 라이브",
    swarm_tag: "CLOUD HPC SERVER & 8 AI AGENT SWARM",
  ...
  de: {
    ...
    foot_security_txt: "🔒 Data Privacy & IP Safeguard Certified",
    btn_lmstudio_open: "⚡ LM Studio KI-Analysator",
    ...
    lms_modal_title: "⚡ LM Studio KI-Analyse-Engine",
    ...
    btn_lms_execute: "⚡ LM Studio KI-Tiefenbericht generieren",
    nav_swarm: "⚡ 8인 AI 전문가 라이브",
    swarm_tag: "CLOUD HPC SERVER & 8 AI AGENT SWARM",
  ...
  fr: {
    ...
    foot_contact_title: "Contact & Support",
    foot_security_txt: "🔒 Data Privacy & IP Safeguard Certified",
    btn_lmstudio_open: "⚡ Analyseur IA LM Studio",
    ...
    lms_modal_title: "⚡ Moteur d'Analyse Avancé LM Studio IA",
    ...
    btn_lms_execute: "⚡ Générer le Rapport Approfondi LM Studio IA",
    nav_swarm: "⚡ 8인 AI 전문가 라이브",
    swarm_tag: "CLOUD HPC SERVER & 8 AI AGENT SWARM",
  ...
  if (btnExecute && promptInput && outputArea) {
    btnExecute.addEventListener('click', async () => {
      ...
      outputArea.innerHTML = currentLang === 'ko' ?
        '⏳ <strong>LM Studio AI 과학자가 심층 분석 보고서를 작성 중입니다...</strong>' :
        '⏳ <strong>LM Studio AI Scientist is synthesizing the in-depth report...</strong>';
